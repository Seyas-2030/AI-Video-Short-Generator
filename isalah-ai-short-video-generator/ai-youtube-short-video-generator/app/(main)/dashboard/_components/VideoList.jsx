    ...
    return (
        <div>
            {videoList?.length == 0 ?
                ...
                justify-center mt-20 gap-5 p-5 border border-dashed rounded-xl py-16'>
                    <Image src='/isalah.png' alt="isalah" width={60} height={60} />
                    ...
                    {videoList?.map((video, index) => (
                        <Link key={index} href={'/play-video/' + video?._id}>
                            <div className='relative'>
                                ...
                                <div className='absolute buttom-3 px-5 w-full'>
                                    <h3>{video?.title}</h3>
