...
function Billing() {
    ...
    return (
        <div>
            ...
            <p className="text-sm p-5 text-gray-500 max-w-2xl">When your credit balance reaches $0, your video generation will stop working.</p>
            <div className="mt-5">
                <h2 className="font-bold text-2xl">Buy More Credits</h2>

                <div className="">
                    {creditsPlans.map((plan, index) => (
                        <div key={index} className="p-5 mt-3 border rounded-xl max-w-2xl flex items-center justify-between">
                            <h2 className="text-xl flex gap-2 item-center">
